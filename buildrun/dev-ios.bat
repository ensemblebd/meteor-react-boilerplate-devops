...
echo meteor run ios --settings settings-mobile.json --mobile-server http://%NetworkIP%:3000
meteor run ios --settings settings-mobile.json --mobile-server http://%NetworkIP%:3000